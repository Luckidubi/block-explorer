...
function TransactionsDetails() {
  ...
  return (
    ...
    <dd className="property-list__value">{txnDetails.transactionHash}</dd>
</dl>
    <dl className="property-list">
    ...
    <dd className="property-list__value">{txnDetails.status === 1 ? "success": "failed"}</dd>
    </dl>
<dl className="property-list">
    ...
    <dd className="property-list__value"><Link to={`/blocks/${txnDetails.blockNumber}`}>{txnDetails.blockNumber}</Link></dd>
    </dl>
    <dl className="property-list">
...
<dd className="property-list__value">{formatEther(txnDetails.effectiveGasPrice)} ETH</dd>
</dl>
<dl className="property-list">
...
<dd className="property-list__value">{formatEther(txnDetails.gasUsed._hex)} ETH</dd>
</dl>
<dl className="property-list">
...
<dd className="property-list__value">{txnDetails.contractAddress}</dd>
</dl>
